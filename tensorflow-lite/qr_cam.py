...
'''
  run_odt_cam(img, signature_fn,input_size):
    img :
    signature_fn : 
    input_size : (width , height)
    threshold :
'''
def run_odt_cam(img, signature_fn,input_size, threshold=0.5):
...
if __name__ == '__main__':
  ...
  while cap.isOpened():
    ...
    detection_result_image = run_odt_cam(image, signature_fn,(input_width,input_height),threshold=DETECTION_THRESHOLD)
